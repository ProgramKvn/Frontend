    ...
    <b-col class="contenedor">
      ...
      >
        <div class="list">
          ...
          <router-link :to="{ name: 'contenidocss', params: { id: tem._id } }">
            <img
...
export default {
  data() {
    return {
      msg: "Curso de CSS",
      temasCurso: [{ tema: "¿Que es CSS?" }],

      images: [
        {
          src: "https://i.ibb.co/xHrZvT0/responsive-design.png",
        },
        { src: "https://i.ibb.co/r4FMy27/archivo-css.png" },
        { src: " https://i.ibb.co/K7FT5mT/web.png" },
      ],
      resultado: [],
    };
  },
  ...
  created() {
    axios.get("http://localhost:3000/api/cursoCSS").then((result) => {
